    ...
    <div className="mx-auto w-full max-w-2xl px-4 py-6 sm:px-6 sm:py-8">
      ...
      <form id="setup-profile-form" action={formAction} className="mt-6 space-y-6">
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-900">
          <h2 className="text-sm font-bold text-slate-900 dark:text-slate-100">Identity</h2>
          <div className="mt-4 grid gap-4 sm:grid-cols-2">
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g. English, Javanese"
                className={fieldBase}
              />
            </div>
          </div>
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-900">
          ...
          <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">
            Fill in as needed — only completed fields appear on the public page.
          </p>
          <div className="mt-4 grid gap-4">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Anything else rescuers should know"
                className={fieldBase}
              />
            </div>
          </div>
          ...
          <label className="mt-4 flex cursor-pointer items-start gap-3">
            ...
            <span>
              ...
              <span className="mt-0.5 block text-xs leading-relaxed text-slate-500 dark:text-slate-400">
                When active, the emergency page can be accessed via NFC/QR scan. Deactivate to hide it.
              </span>
            </span>
          </label>
          ...
          <label className="mt-4 flex cursor-pointer items-start gap-3">
            ...
            <span>
              <span className="flex items-center gap-1.5 text-sm font-semibold text-slate-800 dark:text-slate-200">
                ...
                Show profile on public page
              </span>
              <span className="mt-0.5 block text-xs leading-relaxed text-slate-500 dark:text-slate-400">
                Shows name, photo, and emergency info to anyone who scans the tag.
              </span>
            </span>
          </label>
